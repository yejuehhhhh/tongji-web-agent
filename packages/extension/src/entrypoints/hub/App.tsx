...
import { Logo, StatusDot } from '@/components/misc'
		...
		<div className="flex h-screen bg-background">
			...
			<aside className="w-80 shrink-0 border-r flex flex-col bg-muted/20">
				...
				>
					...
					<span className="text-sm font-semibold tracking-tight">Student Web-Agent Hub</span>
				...
				<div className="flex-1 overflow-y-auto px-5 py-4 space-y-6">
					<div className="text-xs text-muted-foreground leading-relaxed space-y-2">
						<p>
							Student Web-Agent Hub lets local course demos control the browser extension via
							WebSocket.
						</p>
					</div>
	...
	return (
		<div>
			...
			<div className="group/hub relative">
				...
				<div className="group-hover/hub:visible group-hover/hub:opacity-100 left-0 right-0 top-full z-10 pt-2">
					<div className="relative p-2.5 rounded-md border border-border bg-background shadow-md text-muted-foreground text-xs leading-relaxed">
						<div className="absolute -top-1.5 left-5 size-3 rotate-45 rounded-[1px] border-l border-t border-border bg-background" />
