			...
			<div className="flex-1 overflow-y-auto">
					...
					<div className="flex flex-col" aria-label="Loading history" aria-busy="true">
						{[...Array(4)].map((_, i) => (
							<div key={i} className="flex items-start gap-2 px-3 py-2.5 border-b">
								<div className="size-3.5 mt-0.5 rounded-full bg-muted shrink-0" />
				...
				{sessions.map((session) => (
					<div
						...
						className="w-full text-left px-3 py-2.5 border-b hover:bg-muted/50 cursor-pointer flex items-start gap-2 group"
					>
						{/* Status icon */}
